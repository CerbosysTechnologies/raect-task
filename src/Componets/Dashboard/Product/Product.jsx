...
const rows = [
  {
    img: cam, cont: "Camera Mi 360°", sold: '432', unit: '$120', revenue: '$51,840', rating: '4.80'
  },
  {
    img: cam, cont: "Message Gun", sold: '120', unit: '$122', revenue: '$25,840', rating: '3.44'
  },
  {
    img: cam, cont: "Vacuum-mop 2 Pro", sold: '432', unit: '$320', revenue: '$15,840', rating: '3.22'
  },
  {
    img: cam, cont: "vacuum-mop 2", sold: '221', unit: '$234', revenue: '$32,840', rating: '2.00'
  },
];
const Product = () => {
  return (
                ...
                {rows.map((row) => (
                  ...
                  >
                    ...
                    <TableCell align="start">
                      <div className='flex items-center gap-0'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="1.2em" height="1.2em" viewBox="0 0 24 24"><path fill="#ffaa53" d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2L9.19 8.63L2 9.24l5.46 4.73L5.82 21z" /></svg>{row.rating}
                      </div>
                    </TableCell>
                  </TableRow>
                ))}
